...
![sorries](https://img.shields.io/endpoint?url=[[ site_url ]]/badges/sorries.json)
![axioms](https://img.shields.io/endpoint?url=[[ site_url ]]/badges/axioms.json)
![Lean](https://img.shields.io/endpoint?url=[[ site_url ]]/badges/lean.json)
![Mathlib](https://img.shields.io/endpoint?url=[[ site_url ]]/badges/mathlib.json)
![blueprint: no \leanok](https://img.shields.io/endpoint?url=[[ site_url ]]/badges/blueprint_no_leanok.json)
![blueprint: not ready](https://img.shields.io/endpoint?url=[[ site_url ]]/badges/blueprint_not_ready.json)
...
2. Create the GitHub repository, push, and enable **Settings → Pages →
   ...
   the paper-gap index.
3. Replace `[[ project_name ]]/Basic.lean` and `blueprint/src/chapter/ch01.tex` with
