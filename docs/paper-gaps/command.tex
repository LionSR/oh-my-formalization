...
% --- Project configuration: stamped at instantiation; edit if the ----------
% --- repository or site moves. ---------------------------------------------
\newcommand{\projectIssueBase}{https://github.com/example/my-project/issues/}
\newcommand{\projectPrBase}{https://github.com/example/my-project/pull/}
\newcommand{\projectDocBase}{https://example.github.io/my-project/docs/}
% ---------------------------------------------------------------------------
